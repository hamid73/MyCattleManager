...
const VaccinatedBox = ({ eventData, general }) => {
  return (
    <View style={styles.boxStyle} key={eventData.relationId}>
      ...
      <View style={styles.detailsStyle}>
        <Text style={[styles.textStyle, styles.textFont]}>
          {LABELS.setLabel("NameVaccinated")}:
        </Text>
        <Text style={[styles.textDetStyle, styles.textFont]}>
          {eventData.name}
        </Text>
...
const styles = StyleSheet.create({
  header: {
    ...
    padding: 10,
    backgroundColor: COLORS.vaccinatedBox,
    marginBottom: 10,
    flexDirection: "row",
