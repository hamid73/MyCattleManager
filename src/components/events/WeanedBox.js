...
const styles = StyleSheet.create({
  header: {
    ...
    padding: 10,
    backgroundColor: COLORS.weanedBox,
    marginBottom: 10,
    flexDirection: "row",
