...
import { getBreeds } from "../../redux/features/breedSlice";
const BreedsModal = (props) => {
  const { breeds, loading } = useSelector((state) => ({
    ...state.breed,
  }));
        ...
        <View style={styles.modalView}>
          ...
          <View style={styles.body}>
            ...
            >
              <TouchableOpacity
                onPress={() => {
                  setAddEditBreedModalVisible(true);
                  //props.setBreedsData(dataBreeds);
                  setModalVisible(false);
                }}
              >
                <Text style={styles.btnCreate}>
                  {LABELS.setLabel("AddBreedModal")}
                </Text>
              </TouchableOpacity>
            </View>
            <FlatList
              ...
              renderItem={({ item, index }) => (
                ...
                >
                  <TouchableOpacity
                    onPress={() => {
                      setBreed({ id: item.id, name: item.name });
                      setModalVisible(false);
                    }}
                  >
                    <Text
