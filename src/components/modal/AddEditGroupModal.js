...
const AddEditGroupModal = props => {
  ...
  // useEffect(() => {
  //   if (updateGroupData) {
  //     formik.setValues(updateGroupData);
  //   }
  // }, [updateGroupData]);
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      name: Yup.string().required(MESSAGES.setMessage('GroupRequired')),
    }),
    onSubmit: async formValue => {
      if (updateGroupData) {
      } else {
        dispatch(createGroup({formValue, toast}));
        //GROUPSQUERY.newGroup(formValue.name, setGroupsData, toast);
      }
        ...
        <View style={styles.modalView}>
          <View
            ...
            <Pressable
              ...
              onPress={() => {
                setModalVisible(!modalVisible);
                setUpdateGroupData && setUpdateGroupData(null);
                formik.resetForm();
              }}>
            ...
            <Text style={styles.modalText}>
              {updateGroupData
                ? `${LABELS.setLabel('UpdateBreed')}: ${updateGroupData.name}`
